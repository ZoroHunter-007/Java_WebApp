...
<header class="header_section">
    ...
    <a href="menu.jsp" style="text-decoration: none; font-size: 1.2em; color: #f8b739;">Continue Shopping</a>

    <div class="cart-container">
    <h3 class="cart-total"></h3>
    </div>

    <a href="Chekout.jsp" style="display:block; margin-top:20px; background-color:#f8b739; color:#000; text-decoration:none; padding:15px; border-radius:10px;">Proceed to Checkout</a>
